...
function Avatar({
  ...
  return (
    <AvatarPrimitive.Root
      ...
      data-size={size}
      className={cn(
        // The decorative hairline ring follows the avatar's own radius
        // (`rounded-[inherit]`). It used to be hard-coded `rounded-full`,
        // which drew a circle inscribed inside every squared-off avatar.
