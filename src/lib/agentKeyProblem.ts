 ...
 * control, the config pane's crash banner and its This-Computer rail dot)
 * so they can never disagree about which agents are broken, the same way
 ...
 * This Computer section — which is why both crash kinds route to the same
 * warning.
 */
